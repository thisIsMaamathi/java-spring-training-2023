...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("cdw.springtraining.gatekeeper.entites.ApproveRequest", "cdw.springtraining.gatekeeper.entites.Blacklist", "cdw.springtraining.gatekeeper.entites.GateKeeper", "cdw.springtraining.gatekeeper.entites.Resident", "cdw.springtraining.gatekeeper.entites.Roles", "cdw.springtraining.gatekeeper.entites.Token", "cdw.springtraining.gatekeeper.entites.User", "cdw.springtraining.gatekeeper.entites.Visitors");
