 ...
 */
public class GatekeeperApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new GatekeeperApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new GatekeeperApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "cdw.springtraining.gatekeeper.security.SecurityConfig");
