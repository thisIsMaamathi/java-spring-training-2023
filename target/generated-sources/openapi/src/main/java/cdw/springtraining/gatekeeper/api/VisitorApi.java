...
@Validated
@Api(value = "Visitor", description = "the Visitor API")
public interface VisitorApi {
     ...
     */
    @ApiOperation(value = "Visitor can view all their information", nickname = "getVisitorDetails", notes = "", response = ScheduleResponse.class, tags={ "visitor", })
    @ApiResponses(value = { 
