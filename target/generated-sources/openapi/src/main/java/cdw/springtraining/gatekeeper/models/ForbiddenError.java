...
public class ForbiddenError   {
  ...
  private String message = "You are not permitted to view the requested resource";

  public ForbiddenError statusCode(Integer statusCode) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusCode, forbiddenError.statusCode) &&
